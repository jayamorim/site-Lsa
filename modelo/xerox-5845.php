                ...
                <div class="row align-items-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white pt-4">
                            <h1 class="text-white mb-0">WorkCentre® 5845/5855</h1>
                            <p class="lead"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-6 col-lg-6">
                        <div class="image-wrap">
                            <img class="img-fluid" src="assets/img/impressora/5845.jpg" alt="animation image">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="feature-contents section-heading">
                            ...
                            <ul class="check-list-wrap  py-3">
                                ...
                                <li>Ideal para equipes de pequeno e médio porte Produtividade multifuncional sem igual</li>                                                             
                            </ul>
                            <div class="row pt-4">
                                ...
                                <div class="col-4 col-lg-3 border-right">
                                    <div class="count-data text-center">
                                        <h4 class="mb-0 color-primary font-weight-bold">100k</h4>
